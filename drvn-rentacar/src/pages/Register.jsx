...
import { Car, Mail, Lock, User, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="mx-auto flex min-h-[80vh] max-w-md flex-col justify-center px-5 py-16 sm:px-8">
      ...
      <div className="card rounded-2xl p-7">
        ...
        <p className="mt-1 text-sm text-inkDim">Your first rental is 20% off.</p>

        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div>
            <label className="label">Full name</label>
            <div className="input flex items-center gap-3">
              <User size={16} className="text-inkDim" />
              <input
                required
                value={name}
